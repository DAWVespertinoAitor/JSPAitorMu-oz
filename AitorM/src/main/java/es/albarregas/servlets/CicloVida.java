...
public class CicloVida extends HttpServlet {
    ...
    public CicloVida() throws ServletException {
        super();
    ...
    public void init(ServletConfig config) throws ServletException{
        System.out.println("He iniciado"+config.getServletName());
    }
    
    @Override
    public void service(HttpServletRequest request, HttpServletResponse response){
        System.out.println("Servicio usado"+request.getMethod()+" en la ruta "+request.getServletPath());
    }
